...
export default function Settings() {
  ...
  const categories = [
    ...
    {
      id: "privacy",
      name: t("settings.categories.privacy", "Privacy & Security"),
    ...
    {
      id: "legal",
      name: t("settings.categories.legal", "Legal"),
      icon: <FileText className="mr-2 h-4 w-4" />,
      description: t(
        "settings.descriptions.legal",
  ...
  return (
    <>
      <AuthenticatedRoute>
        <Profile />
        <div className="flex flex-col md:flex-row justify-center min-h-screen p-4 gap-6">
          {" "}
              ...
              <div className="sticky top-4 bg-[var(--container)] rounded-lg p-4 shadow-sm">
                ...
                <div className="border-b border-slate-700 mb-4 pb-2">
                  <p className="text-sm text-[var(--foreground)]/70 mb-2">
                    {t(
                      "settings.navigation.settingsPreferences",
          ...
          <div className="flex-1 max-w-3xl">
            ...
            {activeCategory === "subscription" && (
              <div className="bg-[var(--container)] rounded-lg p-6 shadow-sm">
                ...
                <div
                  className={`mb-8 p-6 bg-gradient-to-br rounded-lg border transition-all duration-200 ease-in-out
                ${
                    ...
                    <div>
                      ...
                      !subscriptionEndDate ? (
                        <p className="text-sm text-amber-400 mt-2">
                          {t(
                            "settings.subscription.canceled",
                        ...
                        <p className="text-sm text-amber-400 mt-2">
                          {t(
                            "settings.subscription.canceledUntil",
                    ...
                    <div className="space-y-2 border-b border-[var(--foreground)]/10 pb-4">
                      <div className="flex justify-between">
                        <span className="text-[var(--foreground)]/70">
                          {t("settings.subscription.status", "Status:")}
                        </span>
                        <span
                      ...
                      {subscriptionEndDate && (
                        <div className="flex justify-between">
                          <span className="text-[var(--foreground)]/70">
                            {subscriptionStatus === "canceled"
                              ? t(
                                  "settings.subscription.accessUntil",
                                  "Access Until:",
                                )
                              : t(
                      ...
                      {subscriptionStatus === "canceled" &&
                        new Date(subscriptionEndDate || "") > new Date() && (
                          <p className="text-sm text-amber-400/80 mb-3">
                            {t(
                              "settings.subscription.reactivateMsg",
                ...
                <div className="space-y-6">
                  <div>
                    <h3 className="font-medium text-lg mb-3">
                      {t(
                        "settings.privacy.passwordAuthentication",
                    ...
                    <Link href="/reset-password">
                      ...
                      >
                        ...
                        {t(
                          "settings.privacy.changePassword",
                          "Change Password",
                        )}
                      </Button>
                    </Link>
                  ...
                  <div>
                    <h3 className="font-medium text-lg mb-3">
                      {t("settings.privacy.dataPrivacy", "Data & Privacy")}
                    </h3>
                    <Link href="/privacy">
                      <Button
                        variant="outline"
                    ...
                    <div className="flex items-center">
                      ...
                      <div>
                        ...
                        <p className="text-sm opacity-70">
                          Receive notifications even when you are offline
                        </p>
                      </div>
                    </div>
            ...
            {activeCategory === "help" && (
              <div className="bg-[var(--container)] rounded-lg p-6 shadow-sm">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div className="p-4 bg-[var(--theme)]/10 rounded-lg">
                    <svg
                      className="h-6 w-6 mb-2 text-[var(--foreground)] opacity-70"
                      fill="none"
                      stroke="currentColor"
                      viewBox="0 0 24 24"
                    >
                ...
                <div className="mt-6 p-4 bg-blue-500/10 border border-blue-500/20 rounded-lg">
                  <h3 className="font-medium text-blue-400 mb-2">
                    Lynxky Documentation
                  </h3>
                  <p className="text-sm text-blue-400/80 mb-3">
                    Explore our comprehensive documentation to get the most out
                    of Lynxky
                  </p>
                  <Button
                    variant="outline"
