          ...
          >
            {prevResult.length === 0 && (
              <div className="flex flex-col items-center justify-center h-full text-center px-4 md:px-8 text-gray-400">
                <h2 className="text-3xl font-semibold mb-5 text-[var(--foreground)]">{t('chatAssistent.welcome', 'How can I help you?')}</h2>
                <div className="grid grid-cols-2 md:grid-cols-4 gap-3 mb-8 w-full max-w-2xl">
                  <a href="/editor" className="flex items-center gap-2 bg-[var(--background)] hover:bg-[var(--button-bg2)]/10 border border-[var(--border-color)] rounded-lg p-3 transition-all">
                  ...
                  <a href="/dashboard" className="flex items-center gap-2 bg-[var(--background)] hover:bg-[var(--button-bg2)]/10 border border-[var(--border-color)] rounded-lg p-3 transition-all">
                    <svg className="w-5 h-5 text-[var(--accent-color)]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M4 6h16M4 10h16M4 14h16M4 18h16"></path>
                    </svg>
                    <span>{t('chatAssistent.dashboard', 'Dashboard')}</span>
                  </a>
                  <a href="/settings" className="flex items-center gap-2 bg-[var(--background)] hover:bg-[var(--button-bg2)]/10 border border-[var(--border-color)] rounded-lg p-3 transition-all">
                    <svg className="w-5 h-5 text-[var(--accent-color)]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z"></path>
                    </svg>
                    <span>{t('chatAssistent.settings', 'Settings')}</span>
                  </a>
                  <a href="/privacy" className="flex items-center gap-2 bg-[var(--background)] hover:bg-[var(--button-bg2)]/10 border border-[var(--border-color)] rounded-lg p-3 transition-all">
                    <svg className="w-5 h-5 text-[var(--accent-color)]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            >
              <div className={`max-w-[90%] md:max-w-[80%] ${isUser ? "mr-0" : "ml-0"}`}>
                <div
                ...
                <div className="px-2 flex items-center">
                  ...
                  >
                    {isLoading ? (
                      ...
                      <svg className="h-5 w-5 text-white transform rotate-90" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
