    ...
    <div className="flex justify-center">
      <DropdownMenu>
        ...
        <DropdownMenuContent className="w-48 bg-[var(--background)] border border-[var(--card-border)]">
          <DropdownMenuLabel className="text-[var(--foreground)] opacity-70">
            {t("theme.choose", "Escolha um tema")}
          </DropdownMenuLabel>
          <DropdownMenuSeparator className="bg-[var(--card-border)]" />

          <div className="py-1">
            <DropdownMenuLabel className="text-xs text-[var(--foreground)] opacity-70 px-2">
              {t("theme.basic", "Básicos")}
            </DropdownMenuLabel>
          ...
          <div className="py-1">
            ...
            >
              <div className="flex items-center gap-2 flex-1">
                <div
                  className="w-4 h-4 rounded-full flex items-center justify-center"
                  style={{ backgroundColor: themes[8].color }}
                >
                  {theme === "system" && (
                    <Check size={12} className="text-white" />
                  )}
