...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen bg-[var(--background)]">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">          <div className="flex justify-between items-center h-16">
            <div className="flex items-center">
              <Image 
                ...
                className="mr-3" 
              />
              <h1 className="text-xl font-bold text-[var(--foreground)]">Lynxky</h1>
            </div>
        ...
        <div className="max-w-7xl mx-auto">          <div className="text-center mb-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {features.map((feature, index) => (
              <div key={index} className="bg-[var(--background)] p-6 rounded-xl shadow-sm border border-[var(--border-color)]">
      ...
      {/* Platform Section */}
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-[var(--container)]">        <div className="max-w-7xl mx-auto text-center">
          <h2 className="text-3xl md:text-4xl font-bold text-[var(--foreground)] mb-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">            <div>
              <div className="flex items-center mb-4">
                <Image 
                  ...
                  className="mr-2" 
                />
                <span className="text-lg font-bold text-[var(--foreground)]">Lynxky</span>
              </div>              <p className="text-[var(--foreground)]">
                {t('homepage.footer.description')}
              </p>
            </div>
            <div>
              <h3 className="font-semibold text-[var(--foreground)] mb-4">{t('homepage.footer.product')}</h3>
              <ul className="space-y-2 text-[var(--foreground)]">
                <li><Link href="/features" className="hover:text-[var(--foreground)]">{t('homepage.footer.features')}</Link></li>
                <li><Link href="/pricing" className="hover:text-[var(--foreground)]">{t('homepage.footer.pricing')}</Link></li>
                <li><Link href="/security" className="hover:text-[var(--foreground)]">{t('homepage.footer.security')}</Link></li>
              </ul>
            </div>
            <div>
              <h3 className="font-semibold text-[var(--foreground)] mb-4">{t('homepage.footer.support')}</h3>
              <ul className="space-y-2 text-[var(--foreground)]">
                <li><Link href="/help" className="hover:text-[var(--foreground)]">{t('homepage.footer.helpCenter')}</Link></li>
                <li><Link href="/contact" className="hover:text-[var(--foreground)]">{t('homepage.footer.contactUs')}</Link></li>
                <li><Link href="/account-deletion" className="hover:text-[var(--foreground)]">{t('homepage.footer.deleteAccount')}</Link></li>
              </ul>
            </div>
            <div>
              <h3 className="font-semibold text-[var(--foreground)] mb-4">{t('homepage.footer.legal')}</h3>
              <ul className="space-y-2 text-[var(--foreground)]">
                <li><Link href="/privacy" className="hover:text-[var(--foreground)]">{t('homepage.footer.privacyPolicy')}</Link></li>
                <li><Link href="/terms" className="hover:text-[var(--foreground)]">{t('homepage.footer.termsOfService')}</Link></li>
              </ul>
            </div>
          </div>
